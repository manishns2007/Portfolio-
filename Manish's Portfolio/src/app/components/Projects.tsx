...
export function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      github: "https://github.com/manishns2007/Degree-Decider"
    },
    {
      icon: Activity,
      title: "PulmoDetect",
                ...
                <div className="relative z-10">
                  ...
                  >
                    ...
                    <Button
                      variant="outline"
                      size="sm"
                      className="flex-1 border-gray-600 text-gray-300 hover:border-purple-500 hover:text-purple-400 hover:bg-purple-500/10"
                    >
